...
export default function SearchMenu() {
  ...
  return (
    <motion.div 
        ...
        className="fixed bottom-[96px] left-1/2 -translate-x-1/2 w-[90%] md:w-[760px] h-[720px] max-h-[85vh] rounded-[2rem] shadow-[0_15px_50px_rgba(0,0,0,0.5)] border border-white/10 flex flex-col pt-8 pb-0 z-[101] text-white select-none overflow-hidden"
        style={{ 
